    ...
    public partial class Form9 : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            if (textBox1.Text == Form4.ID && textBox2.Text == Form4.password)
            {
                ...
                connection.ConnectionString = "Data Source=LAPTOP-HTEE4N8I\\AHMEDSQLSERVER;Initial Catalog=MovieRental;Integrated Security=True";
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            if (textBox1.Text == Form4.ID && textBox2.Text == Form4.password)
            {
                SqlConnection connection = new SqlConnection();
                connection.ConnectionString = "Data Source=LAPTOP-HTEE4N8I\\AHMEDSQLSERVER;Initial Catalog=MovieRental;Integrated Security=True";
                SqlCommand Command = new SqlCommand("update ADMIN set A_mail = '" + textBox4.Text + "' where ADMIN_ID = '" + textBox1.Text + "'", connection);
